    ...
    <Link to={`/profile/${user._id}`}>
      <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden hover:translate-y-[-4px] h-full flex flex-col">
        ...
        <div className="px-6 pb-6 flex flex-col flex-grow">
          ...
          {/* CTA Button */}
          <button className="mt-auto w-full bg-gradient-to-r from-teal-600 to-teal-500 text-white px-4 py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2">
            <svg
              className="w-4 h-4"
              fill="none"
              stroke="currentColor"

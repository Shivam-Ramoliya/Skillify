          ...
          <>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={loading}
                className="flex-1 py-3 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-red-600 to-rose-600 shadow-lg shadow-red-500/30 hover:shadow-red-500/50 hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:transform-none"
              >
          ...
          <>
            ...
            {countdown > 0 && (
              <p className="text-center text-sm font-semibold mb-4">
                ...
                <span
                  className={countdown < 60 ? "text-red-600" : "text-slate-700"}
                >
            ...
            <button
              ...
              onClick={handleSendOtp}
              disabled={loading}
              className="w-full text-center text-xs text-slate-500 font-semibold hover:text-blue-600 transition-colors disabled:opacity-50"
            >
